...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cool-king-8449
```

A live public deployment of this template is available at [https://cool-king-8449.templates.workers.dev](https://cool-king-8449.templates.workers.dev)
